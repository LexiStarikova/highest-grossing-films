    ...
    new Chart(bubbleCtx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Top 10 Films by Year and Box Office Revenue (Bubble size: cube root scale)',
                    font: { size: 24 }
                },
                legend: {
                    display: false
